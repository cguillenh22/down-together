---
title: "NIH's INCLUDE Project Launches a Cohort Study Tracking Down Syndrome Health From Birth to Adulthood"
description: "A look at the NIH INCLUDE Project's new $20 million initiative and the relaunch of DS-Connect, two key tools accelerating Down syndrome biomedical research."
lang: "en"
pubDate: 2026-07-25
level: "avanzado"
...
The Eunice Kennedy Shriver National Institute of Child Health and Human Development (NICHD), part of NIH, announced a new phase of its INCLUDE Project focused on observing the health of people with Down syndrome across the entire lifespan. According to NICHD, <cite index="10-1">the NIH INCLUDE Project launched a new long-term study, called the Down Syndrome Cohort Development Program, to observe and track health data of people with Down syndrome from birth to adulthood</cite>. This reflects a substantial financial commitment: <cite index="10-2">the INCLUDE Project was launched by NIH in 2018 and has invested nearly $435 million in over 350 awards</cite>, involving many institutes within the nation's leading medical research agency.
